                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="p-20">
                                    ...
                                    <?php
                                    if($details['category_id'] == 4 || $details['category_id'] == 9 || $details['category_id'] == 10 || $details['category_id'] == 5 || $details['category_id'] == 6)
                                    {
                                        ?>
                                        <div class="batches">
                                            ...
                                            <form class="col-lg-2 pull-right">
                                                <div class="form-group">
                                                    <div class="row">
                                                    <input class="dpd1 form-control border" required="" readonly  autocomplete="off" data-date-format="dd-mm-yyyy" placeholder="Select date" type="text" name="date" id="datepickerrr" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="p-20">
                                    <form role="form" action="javascript:void(0)" method="post" id="place_offline_order">
                                        <br style="clear:both">

                                        <div class="form-group">
                                            <input type="number" class="form-control" id="capacity" name="capacity" placeholder="No of Guests" min="1" required>
                                        </div>
                                        <?php
                                        if($details['category_id'] == 4 || $details['category_id'] == 9 || $details['category_id'] == 10 || $details['category_id'] == 5 || $details['category_id'] == 6)
                                        {
                                        ...
                                        else
                                        {
                                            ?>
                                            <div class="form-group">
                                                <input class="dpd1 form-control border datepicker" required="" data-date-format="dd-mm-yyyy" placeholder="Select date" type="text" name="date" id="datepickerrr" autocomplete="off">
                                            </div>
                                            <?php
                                        }
                                        ?>
                                        ...
                                        <input type="hidden" name="left_capacity" id="left_capacity" value="0">

                                        <input type="hidden" name="date" id="date" value="">
                                        <input type="hidden" name="amount_paid" id="amount_paid" value="<?=$details['token_amount'];?>">
                                        <input type="hidden" name="total_capacity" id="total_capacity" value="<?=$details['people_capacity'];?>">
    ...
    $(document).ready(function () {
        ...
        { //alert();
            ...
            if($details['category_id'] == 4 || $details['category_id'] == 9 || $details['category_id'] == 10 || $details['category_id'] == 5 || $details['category_id'] == 6)
            {
                ...
                var left_capacity = $("#left_capacity").val();
                var category_id = $("#category_id").val();
                if(capacity > left_capacity && (category_id == 5 || category_id == 6))
                {
                    alert('Entered Guests capacity is more than selected slot capacity!');
                    return false;
                    exit;
                }
                if(date == "")
