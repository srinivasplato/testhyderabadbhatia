        ...
        <div class="batches">
          ...
          <div class="select-capacity col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5 col-xs-5">
                    <div class="row">
                      ...
                      if($venue_details['date'] == "1970-01-01" || $venue_details['date'] =="01-01-1970" || $venue_details['date'] == "")
                      {
            ...
            if(!empty($venue_details['check_slots_available']) && $capacity)
            {
                ...
                {
                    // echo $csa['capacity_booked'];
                    // echo $csa['slot_capacity'];
          ...
          <hr>
            ...
            <div class="book-venue">
              <a onclick="open_popup()" class="label-one theme-color-bg">
                <i class="fa fa-inr"></i> <strong id="book_amount1">
                  <?php echo $venue_details['token_amount']; ?> /-
                </strong> Book(Token Amount)
              </a>
              </p>
            </div>
            </div>
      ...
      <div class="col-md-4 sx-mt-50">
        ...
        <div class="visible-desktop">
          <div class="mb-30">
            ...
            {
                ?>
                <div class="book-venue"><a class="label-one theme-color-bg" onclick="book_now('<?=$venue_details['category_id'];?>','<?=$venue_details['vendor_id'];?>','<?=$venue_details['venue_id'];?>', '<?=$venue_details['token_amount'];?>', <?=$venue_details['people_capacity'];?>, '', '<?=$venue_details['booking_type'];?>')"><i class="fa fa-inr"></i> <strong> <?php echo $venue_details['token_amount']; ?> /-</strong> Book This Venue </a></p></div>
                <?php
            }
            else
            {
                ?>
                <div class="book-venue"><a class="label-one theme-color-bg" onclick="book_now('<?=$venue_details['category_id'];?>','<?=$venue_details['vendor_id'];?>','<?=$venue_details['venue_id'];?>', '<?=$venue_details['token_amount'];?>', '', '', '<?=$venue_details['booking_type'];?>')"><i class="fa fa-inr"></i> <strong> <?php echo $venue_details['token_amount']; ?> /-</strong> Book This Venue </a></p></div>
                <?php
            }
            ?> -->
            <?php
            ...
            <div class="book-venue">
              <a onclick="open_popup()" class="label-one theme-color-bg">
                <i class="fa fa-inr"></i> <strong id="book_amount">
                  <?php echo $venue_details['token_amount']; ?> /-
                </strong> Book(Token Amount)
              </a>
              </p>
    ...
    $('.payment_type').click(function()
    {
        ...
        $.ajax( {
            ...
            success: function(data) { //alert(data);exit;
                ...
                else if(str[0] == "placed")
                {
                    //$('#order_success').html('Your order has been placed successfully. Thank You.').show();
                    alert('This slot is already booked. Please book someother slot.');
                    location.reload();
                }
