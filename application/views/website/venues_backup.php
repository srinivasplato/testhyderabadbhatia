...
$tdate = date('Y-m-d');
?>
<section class="breadcrumb-bg bg-5 white-color">   
        ...
        <div class="widget-search filter-section hidden-lg hidden-md">
            <div class="row">
                <div class="search-selectpicker selectpicker-wrapper col-lg-6 col-md-6 col-xs-6">
                    <a href="Javascript:void(0);" class="sort-button">Sort<i class="fa fa-long-arrow-up" aria-hidden="true"></i><i class="fa fa-long-arrow-down" aria-hidden="true"></i></a>
                </div>
                <div class="search-selectpicker selectpicker-wrapper col-lg-6 col-md-6 col-xs-6">
                 ...
                 <h4 class="fsz-15 "> Sort By <i class="fa fa-long-arrow-down pull-right" aria-hidden="true"></i> <i class="fa fa-long-arrow-up pull-right" aria-hidden="true"></i>
                    ...
                    <div class="widget-wrap filter-wrap">
                        ...
                        <form class="search-form" method="post">
                            ...
                            <?php
                            //echo $filters[4];
                            if(isset($filters[4]) && $filters[4] != 8 && $filters[4] != 9)
                            {                                
                                ?>
                                <div class="search-selectpicker selectpicker-wrapper">
                        ...
                        <p>Select Date</p>
                        <div class="col-lg-12">
                            <input placeholder="Select Date" required=""  class="form-control" rel="" type="date" style="padding-left: 5px;" value="<?php echo (isset($filters[7]) && $filters[7])? $filters[7]:"" ;?>" onchange="update_filter(this.value, 'date')" min="<?=date('Y-m-d', strtotime($tdate. ' + 2 days'));?>">
                            </div>
                            </div>
                        </div>                   
                    </form>
...
<section class="newsletter">
    <div class="">
        <div class="container theme-color-bg">
            <form class="newsletter-form phone">
                <div class="col-md-10 col-sm-12">
                    <p class="info"> <strong> Call Us </strong> to  <b>+91-999 999 9999</b> or just send us mail, we will get back to you soon... </p>
                </div>
                <!--<div class="col-md-7 col-sm-8">
                    <input placeholder="Your email address" required="" class="" type="text">
                </div>-->
                <div class="col-md-2 col-sm-4">
                    <button class="theme-btn btn-2" type="submit"> Get in touch with us </button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    function update_filter(val, filter_type)
    {
        ...
        if ( !segments[7] )
        {
            if(filter_type == "sort"){ var val = val; }else if(filter_type == "veg"){ var val = ','+val; }else if(filter_type == "ac"){ var val = ',,'+val; }else if(filter_type == "areas"){ var val = ',,,'+val; }else if(filter_type == "categories"){ var val = ',,,,'+val;}else if(filter_type == "areas"){ var val = ',,,,,'+val; }else if(filter_type == "event_types"){ var val = ',,,,,'+val; }else if(filter_type == "quantity"){ var val = ',,,,,,'+val; }else if(filter_type == "date"){ var val = ',,,,,,,'+val; }
