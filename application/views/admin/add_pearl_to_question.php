    ...
    <div class="col-md-12">
      ...
      ?>
        <div class="panel panel-default">
          ...
          <?php 
            if($question_id !=''){?>
            <h2 class="panel-title">Add Flash Card to Question</h2>    
            <?php }else{?>
             <h2 class="panel-title">Add Flash Card</h2>  
            <?php }?>        
          </div>
          ...
          <div class="panel-body">
              ...
              <div class="col-md-6 col-xs-12">
                <select class="form-control" name="course_id" id="course_id" required="" onchange="getss(this.value)">
                  ...
                  <option value="<?php echo $question['course_id']?>"><?php echo $question['course_name']?></option>
               <?php  }else{?>
          ...
          <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">                
                <select class="form-control" name="subject_id" id="subject_id" required="" onchange="getqbankchapters(this.value)">
                 ...
                 <?php 
                 if($question_id !=''){?>
                 <option value="<?php echo $question['subject_id']?>"><?php echo $question['sname']?></option>
                 <?php }else{?>
                    <option value="">--Select--</option>
                  <?php }?>
                </select>
          ...
          <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">                
                ...
                if($question_id !=''){?>
                  ...
                  <option value="<?php echo $question['topic_id']?>"><?php echo $question['qtname']?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">                
                ...
                <?php 
                if($question_id !=''){?>
                <option value="<?php echo $question['qbank_topic_id']?>"><?php echo $question['qbanktopicname']?>
                <?php  }else{?>
                  <option value="">--Select--</option>
                  <?php }?>
                </select>
        ...
        <?php 
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <input class="" type="radio" name="peral_type" value="new" checked >
                <label for="yes">New One OR</label>
                
                 </br>
               
                <input class="" type="radio" name="peral_type" value="exist">
                <label for="yes">Select Existing Flash Card</label>
         ...
         <?php }else{?>
          <input type="hidden" class="form-control" name="peral_type" value="new"   />
          <?php }?>
         ...
         <div id="pearl_div">
          ...
          <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  <input type="text" class="form-control" name="icon_image" id="icon_image"  />
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <?php 
                if($question_id !=''){?>                  
                <textarea class="form-control editor_cls" rows="5" name="explanation" id="content" required=""><?php echo $question['explanation']?></textarea>
                <?php }else{?>
                <textarea class="form-control editor_cls" rows="5" name="explanation" id="content" required=""></textarea>
            ...
            <div id="existing_pearls" style="display: none">

            <div class="form-group">
              <label class="col-md-3 col-xs-12 control-label">Select Pearl</label>
              <div class="col-md-6 col-xs-12">
                <select class="form-control" name="exist_pearl_id" id="exist_pearl_id">
                  
                  <?php 
                  foreach($existing_pearls as $pearl){?>
                  
                  <option value="<?php echo $pearl['id']?>" ><?php echo $pearl['title']?></option>
                  <?php 
                  }?>
                  </option>
            ...
            <input type="hidden" class="form-control" name="question_id" value="<?php echo $question_id?>" id="question_id"  />
...
$('input:radio[name="peral_type"]').change(
    function(){
        if ($(this).is(':checked') && $(this).val() == 'new') {
            // append goes here
            //alert('new');
            $("#pearl_div").show();
            $("#existing_pearls").hide();

        }else if($(this).is(':checked') && $(this).val() == 'exist'){
            //alert('exist');

            $("#pearl_div").hide();
            $("#existing_pearls").show();
