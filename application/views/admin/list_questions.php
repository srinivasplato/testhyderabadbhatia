    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Questions</h2>
        </div>
         <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_questions" class="btn btn-success">Add</a></h3>
        </div>
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <table id="questions" class="table datatable table-striped">
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <div class="col-md-2">
              <button type="button" id="search_questions" class="btn btn-info margin_search" style=""><i class="fa fa-search icon-style"></i></button>
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/questions'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_questions'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Actions", "name":"action", "orderable": false, "deafultContent":"", "data":"id",
             "width":"0%", "class":"td_action"},
            { "title": "Questions", "name":"question","orderable": false, "data":"question", "width":"0%" },
            { "title": "Options", "name":"options","orderable": false, "data":"options", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          var status ='<a href="'+url+'admin/register/delete_questions/'+aData['id']+'" class="btn btn-danger btn-condensed" title="Delete Questions"><i class="fa fa-trash"></i></a>';
          $(nRow).find('td:eq(1)').html(status);


          var action ='<a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_questions/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
