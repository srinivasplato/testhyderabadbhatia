    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Quiz Feedback</h2>
        </div>
        <!-- <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_feedback" class="btn btn-success">Add</a></h3>
        </div> -->
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/feedback'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_feedback'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        //    { "title": "Actions", "name":"action", "orderable": false, "deafultContent":"", "data": "id", "width":"0%", "class":"td_actionn"},
            ...
            { "title": "Feedback", "name":"feedback","orderable": false, "data":"feedback", "width":"0%" },
            { "title": "Ratings", "name":"ratre","orderable": false, "data":"ratre", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          // var action ='<a class="btn btn-warning btn-condensed"  <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_feedback/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
