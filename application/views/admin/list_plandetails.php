...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">plandetails</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> plandetails</h2>
        </div>
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_plandetails" class="btn btn-success">Add</a></h3>
        </div>
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              <div class="col-md-3 col-md-offset-3" style="padding:0">
                 ...
                 <div class="col-md-2">
                  <select name="search_on_1" id="search_on_1" class="form-control input-sm custom-input">
                      ...
                      <option value="2">plan Type</option>
                  </select>
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/plandetails'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_plandetails'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Actions", "name":"action", "orderable": false, "deafultContent":"", "data": "id", "width":"0%", "class":"td_actionn"},
             { "title": "Plan Type", "name":"plan_type","orderable": false, "data":"plan_type", "width":"0%" },
            { "title": "Plan Name", "name":"plan_name","orderable": false, "data":"plan_name", "width":"0%" },
             { "title": "Tests Access", "name":"tests_access","orderable": false, "data":"tests_access", "width":"0%" },
             { "title": "Q Bank Access", "name":"q_bank_access","orderable": false, "data":"q_bank_access", "width":"0%" },
             { "title": "videos Access", "name":"videos_access","orderable": false, "data":"videos_access", "width":"0%" },
             { "title":"price", "name":"price","orderable": false, "data":"price", "width":"0%" },
