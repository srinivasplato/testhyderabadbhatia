      ...
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Edit Qbank Sub Topics</h3>            
          </div>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">                
                ...
                <?php foreach($qbankTopics as $topic){?>
                  ...
                  <option value="<?php echo $topic['id']?>" <?php if($topic['id'] == $exams->topic_id){ ?>selected <?php } ?> ><?php echo $topic['name']?></option>
                  <?php 
                  }?>
                </select>
              </div>
            ...
            <div class="form-group">
              <label for="topic_name" class="col-md-3 col-xs-12 control-label">Enter Sub Topic Name</label>
              <div class="col-md-6 col-xs-12">                
           ...
           <!-- <input type="hidden" name="banner_image" value="<?=$exams->banner_image;?>">   
            ...
            <input type="hidden" name="icon_image" value="<?=$exams->icon_image;?>">-->
             

          <input type="hidden" name="qbanksubtopic_id" id="qbanksubtopic_id" value="<?=$exams->id;?>">
