...
<ul class="breadcrumb">
  ...
  <li class="active">Update Images Gallery</li>
</ul>
<!-- END BREADCRUMB -->
      ...
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Update Images Gallery</h2>            
          </div>
          ...
          <div class="panel-body">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="">
                  ...
                  <input type="file" class="fileinput btn-primary" name="image" id="image" required="" />
                   ...
                   <?php if($row->image !=''){?>
              <img src="<?php echo base_url().$row->image;?>" height="100" width="100">
              <?php }else{?>
            ...
            <div class="form-group">
              <label for="image" class="col-md-3 col-xs-12 control-label">Note</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                 
                  <input type="text" class="form-control" name="note" id="image" value="<?php echo $row->note;?>" />
                </div>
              </div>
            </div>

            <input type="hidden" class="form-control" name="image_id" value="<?php echo $row->id;?>" />
