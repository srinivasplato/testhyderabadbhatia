      ...
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Add Video Chapters</h2>            
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="title" class="col-md-3 col-xs-12 control-label">Enter Chapter Name </label>
              <div class="col-md-6 col-xs-12">                
            ...
            <div class="form-group">
              <label class="col-md-3 col-xs-12 control-label">Enter Banner Image Path</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
            ...
            <div class="form-group">
              <label class="col-md-3 col-xs-12 control-label">Enter Icon Image Path</label>
              <div class="col-md-6 col-xs-12">
                <div class="">
                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
