    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-edit"></span>Agent Commissions</h2>
        </div>
        <div class="col-md-6 col-xs-6">
              ...
              <div class="col-md-3 col-md-offset-3" style="padding:0">
                ...
                <div class="col-md-2">
                  <select name="search_on_1" id="search_on_1" class="form-control input-sm custom-input">
                      ...
                      <option value="2">Agent Mobile</option>
                  </select>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_agent_commissions'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Agent Mobile", "name":"agent_mobile","orderable": false, "data":"agent_mobile", "width":"0%" },

            { "title": "Specialisation", "name":"agent_specialisation","orderable": false, "data":"agent_specialisation", "width":"0%" },
            ...
            { "title": "Coupon code", "name":"applied_coupon","orderable": false, "data":"applied_coupon", "width":"0%" },

            { "title": "Discount(%)", "name":"coupon_discount","orderable": false, "data":"coupon_discount", "width":"0%" },
