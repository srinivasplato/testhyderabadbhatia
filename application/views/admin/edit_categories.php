...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      ...
      echo form_open_multipart('admin/register/update_categories', $attributes); 
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Edit Categories</h3>            
          </div>
          ...
          <div class="panel-footer">
            ...
            <a href="<?=base_url();?>admin/register/categories" class="btn btn-primary pull-right" style="margin-left:10px;">Cancel</a>            
