    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Video Chapters</h2>
        </div>
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_videochapters" class="btn btn-success">Add</a></h3>
        </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_videochapters'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": " subject Name", "name":"sname","orderable": false, "data":"sname", "width":"0%" },
             { "title": "Chapter Name", "name":"topic_name","orderable": false, "data":"name", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          $(nRow).find('td:eq(6)').html(icon);
            
        
          var action ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/register/edit_videochapters/'+aData['id']+'"><i class="fa fa-edit"></i></a> <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_videochapters/'+aData['id']+'"><i class="fa fa-trash"></i></a>';

          $(nRow).find('td:eq(10)').html(action);

          if(aData['status'] == "Active")
          {
            var status ='<a title="Click to Inactive" href="'+url+'admin/register/change_videochapters_status/'+aData['id']+'/Inactive" class="btn btn-success btn-condensed">ON</a>';
          }
          else
          {
            var status ='<a title="Click to Active" href="'+url+'admin/register/change_videochapters_status/'+aData['id']+'/Active" class="btn btn-danger btn-condensed">OFF</a>';
          }
