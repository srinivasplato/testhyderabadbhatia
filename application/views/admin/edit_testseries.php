...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><a href="#">testseries</a></li>
  <li class="active">Edit testseries</li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      ...
      echo form_open_multipart('admin/register/update_testseries', $attributes); 
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Edit testseries</h3>            
          </div>
          ...
          <input type="hidden" name="testseries_id" value="<?=$row->id;?>">
          <input type="hidden" name="imgurl" value="<?=$row->image;?>">
              
          <div class="panel-footer">
            <!-- <button class="btn btn-default">Clear Form</button> -->
            <a href="<?=base_url();?>admin/register/testseries" class="btn btn-primary pull-right" style="margin-left:10px;">Cancel</a>            
