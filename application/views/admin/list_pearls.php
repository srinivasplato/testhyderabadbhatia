...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">quiz_questions</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Qbank Flash Cards</h2>
        </div>
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_pearl_to_question" class="btn btn-success">Add</a></h3>
        </div>
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              <div class="col-md-3 col-md-offset-3" style="padding:0">
                ...
                <div class="col-md-2">
                  <select name="search_on_1" id="search_on_1" class="form-control input-sm custom-input">
                    ...
                    <option value="4">CHAPTER NAME</option>
                    <option value="5">TITLE</option>
                    <option value="6">Pearl Number</option>
                    <!-- <option value="7">Question ID</option> -->
                  </select>
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/pearls'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_pearls'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Course Name", "name":"ename","orderable": false, "data":"ename", "width":"0%" }, 
             ...
             { "title": "Peral No", "name":"pearl_number","orderable": false, "data":"pearl_number", "width":"0%" },
            ...
            { "title": "View Questions", "name":"id","orderable": false, "data":"id", "width":"0%" },
        ...
        {            
          ...
          var view_que ='<a title="Click to Active" href="'+url+'admin/register/add_questions_to_pearl/'+aData['id']+'" class="btn btn-success btn-condensed">View Questions</a>';

           $(nRow).find('td:eq(8)').html(view_que);

          if(aData['status'] == "Active")
          {
            var status ='<a title="Click to Inactive" href="'+url+'admin/register/change_pearl_status/'+aData['id']+'/Inactive" class="btn btn-success btn-condensed">ON</a>';
          }
          else
          {
            var status ='<a title="Click to Active" href="'+url+'admin/register/change_pearl_status/'+aData['id']+'/Active" class="btn btn-danger btn-condensed">OFF</a>';
          }
          $(nRow).find('td:eq(9)').html(status);

          var action ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/register/edit_pearls/'+aData['id']+'"><i class="fa fa-edit"></i></a> <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_pearls/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
