...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">chapters_slides</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Chapters Slides</h2>
        </div>
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_chapters_slides" class="btn btn-success">Add</a></h3>
        </div>
        </div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <div class="col-md-2">
                  <select name="search_on_1" id="search_on_1" class="form-control input-sm custom-input">
                     <option value="1">ChapterName</option>
                  </select>
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/chapters_slides'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_chapters_slides'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Chapter Name", "name":"chapter_name","orderable": false, "data":"chapter_name", "width":"0%" },
            
            
            { "title": "Slide Image", "name":"image","orderable": false, "data":"image", "width":"0%" },
            
            { "title": "Slide Status", "name":"chapters_status","orderable": false, "data":"chapters_status", "width":"0%" },
