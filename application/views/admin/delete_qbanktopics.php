...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      ...
      echo form_open_multipart('admin/register/delete_qbanktopics/'.$qbank_topic_id, $attributes); 
      ?>
        <div class="panel panel-default">
          </br>
            <h3 style="color:red">Once delete this Qbank Topic below dependent lists are deleted</h3>
          </br>
          </hr>
              </br>
       ...
       <?php }}else{
        echo '<h5 style="color:green">No SubTopics Found</h5>';
          ...
          <input type="hidden" name="qbank_topic_id" value="<?php echo $qbank_topic_id;?>">
