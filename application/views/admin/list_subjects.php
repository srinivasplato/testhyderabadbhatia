    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Subjects</h2>
        </div>
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_subjects" class="btn btn-success">Add</a></h3>
        </div>
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/subjects'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_subjects'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Course Name", "name":"name","orderable": false, "data":"name", "width":"0%" },
            { "title": " subject Name", "name":"subject_name","orderable": false, "data":"subject_name", "width":"0%" },
            { "title": "Image", "name":"image","orderable": false,"defaultContent": "No Image", "data":"image", "width":"0%" },

             { "title": "Qbank Image", "name":"icon","orderable": false,"defaultContent": "No Image", "data":"icon", "width":"0%" },

             { "title": "Order", "name":"order","orderable": false,"defaultContent": "order", "data":"order", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          var icon_path= aData['icon'];
          //var icon_file_status=doesFileExist(icon_path);

          if(aData['icon'] !=''){
           var icon = '<img src="'+aData['icon']+'" height="50" width="50">';
          }else{
