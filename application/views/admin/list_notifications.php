  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_notifications" class="btn btn-success">Add</a></h3>
        </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        {
          var action ='<a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_notifications/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
