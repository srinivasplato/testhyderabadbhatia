...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">Qbank Topics</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Qbank Topics</h2>
        </div>
        <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_qbanktopics" class="btn btn-success">Add</a></h3>
        </div>
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              <div class="col-md-3 col-md-offset-3" style="padding:0">
                ...
                <div class="col-md-2">
                  <select name="search_on_1" id="search_on_1" class="form-control input-sm custom-input">
                    ...
                    <option value="3">CHAPTER NAME</option>
                    <option value="4">TOPIC NAME</option>
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/qbanktopics'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_qbanktopics'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": " subject Name", "name":"sname","orderable": false, "data":"sname", "width":"0%" },
             { "title": "Chapter Name", "name":"topic_name","orderable": false, "data":"chapter", "width":"0%" },
             { "title": "Topic Name", "name":"topic_name","orderable": false, "data":"name", "width":"0%" },
          ...
          { "title": "Icon Image", "name":"icon_image","orderable": false, "data":"icon_image", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          var icon_path= aData['icon_image'];
          //var icon_file_status=doesFileExist(icon_path);

          if(aData['icon_image'] !=''){
           var icon = '<img src="'+aData['icon_image']+'" height="50" width="50">';
          }else{
        ...
        var QList ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/register/qbanktopic_questions_list/'+aData['id']+'">Questions List  <i class="fa fa-edit"></i></a> ';
        $(nRow).find('td:eq(1)').html(QList);

          var action ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/register/edit_qbanktopics/'+aData['id']+'"><i class="fa fa-edit"></i></a> <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_qbanktopics/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
          $(nRow).find('td:eq(13)').html(action);


          if(aData['status'] == "Active")
          {
            var status ='<a title="Click to Inactive" href="'+url+'admin/register/change_qbanktopics_status/'+aData['id']+'/Inactive" class="btn btn-success btn-condensed">ON</a>';
          }
          else
          {
            var status ='<a title="Click to Active" href="'+url+'admin/register/change_qbanktopics_status/'+aData['id']+'/Active" class="btn btn-danger btn-condensed">OFF</a>';
          }
          $(nRow).find('td:eq(12)').html(status);
        },
