...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><a href="#">examss</a></li>
  <li class="active">Add examss</li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      ...
      echo form_open_multipart('admin/register/update_examss/insert', $attributes); 
      ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Add examss</h2>            
          </div>
          ...
          <div class="panel-footer">
            <a href="<?=base_url();?>admin/register/examss" class="btn btn-primary pull-right" style="margin-left:10px;">Cancel</a>    
