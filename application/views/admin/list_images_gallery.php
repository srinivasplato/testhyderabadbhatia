...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">Images Gallery</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Images Gallery</h2>
        </div>
         <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_images_gallery" class="btn btn-success">Add</a></h3>
        </div> 
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_imageGallery'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Note", "name":"note","orderable": false, "data":"note", "width":"0%" },
            { "title": "Image Path", "name":"image","orderable": false, "data":"image", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          var image_path = '<p>'+aData['image']+'</p>';
         
          $(nRow).find('td:eq(2)').html(image_path);
