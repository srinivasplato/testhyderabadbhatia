...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">group_videos</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> group_videos</h2>
        </div>
      <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_group_videos" class="btn btn-success">Add</a></h3>
        </div> 
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/group_videos'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_group_videos'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "group", "name":"group_name","orderable": false, "data":"group_name", "width":"0%" },
            
             { "title": "video", "name":"video","orderable": false, "data":"video", "width":"0%" },
        ...
        {           
          ...
          var video = '<video width="100" height="100" controls><source src="'+url+aData['video']+'" type="video/mp4"></source></video>';
          
         
         
          $(nRow).find('td:eq(3)').html(video);
            
          var action ='<a class="btn btn-warning btn-condensed" title="edit" href="'+url+'admin/register/edit_group_videos/'+aData['id']+'"><i class="fa fa-edit"></i></a>';
          //$(nRow).find('td:eq(0)').html(action);

          var action =' <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_group_videos/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
