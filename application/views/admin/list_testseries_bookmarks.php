...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li class="active">Testseries Bookmarks</li>
</ul>
<!-- END BREADCRUMB -->
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="col-md-6 col-xs-6">
          <h2><span class="fa fa-list"></span> Test Series Bookmarks</h2>
        </div>
        <!-- <div class="col-md-6 col-xs-6">
          <h3 class="panel-title" style="float: right;"><a href="<?=base_url();?>admin/register/add_quiz_reports" class="btn btn-success">Add</a></h3>
        </div> -->
        </div>
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/register/testseries_bookmarks'); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/register/all_testseries_bookmarks'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "User Name", "name":"uname","orderable": false, "data":"uname", "width":"0%" },
            { "title": "Course Name", "name":"ename","orderable": false, "data":"ename", "width":"0%" },
            { "title": "Category Name", "name":"tcname","orderable": false, "data":"tcname", "width":"0%" },
    
            { "title": "quiz Title", "name":"tsqt","orderable": false, "data":"tsqt", "width":"0%" },
            { "title": "Question", "name":"tsqques","orderable": false, "data":"tsqques", "width":"0%" },
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) 
        {
          ...
          // var action ='<a class="btn btn-warning btn-condensed"  <a onclick="return confirm('+"'Are you sure want to delete?'"+');" class="btn btn-danger btn-condensed" title="delete" href="'+url+'admin/register/delete_quiz_reports/'+aData['id']+'"><i class="fa fa-trash"></i></a>';
